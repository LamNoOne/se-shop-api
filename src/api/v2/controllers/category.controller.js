...
const categoryService = require("~/api/v2/services/category.service")
...
const getProductsByCategoryId = asyncHandling(async (req, res) => {
    ...
    const allProductPromise = categoryService.getProductsByCategoryId({
        categoryId: id,
        filter,
    })
    const productsPromise = categoryService.getProductsByCategoryId({
        categoryId: id,
        filter,
        selector,
        pagination,
