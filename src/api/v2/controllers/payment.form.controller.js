...
const paymentFormService = require("~/api/v2/services/payment.form.service")
...
const createPaymentForm = asyncHandling(async (req, res) => {
    ...
    const paymentForm = await paymentFormService.createPaymentForm({
        name,
        description,
    })
...
const getAllPaymentForms = asyncHandling(async (req, res) => {
    ...
    const paymentForms = await paymentFormService.getAllPaymentForms({
        filter,
        selector,
        pagination,
        sorter,
...
const updatePaymentFormById = asyncHandling(async (req, res) => {
    ...
    const paymentForm = await paymentFormService.updatePaymentFormById(id, {
        name,
        description,
    })
