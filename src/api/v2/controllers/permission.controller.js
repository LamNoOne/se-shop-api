...
const resourceService = require("~/api/v2/services/permission.service")
...
const createPermission = asyncHandling(async (req, res) => {
    ...
    const permission = await resourceService.createPermission({
        name,
        description,
        api,
        method,
...
const getAllPermissions = asyncHandling(async (req, res) => {
    ...
    const permissions = await resourceService.getAllPermissions({
        filter,
        selector,
        pagination,
        sorter,
...
const updatePermissionById = asyncHandling(async (req, res) => {
    ...
    const permission = await resourceService.updatePermissionById(id, {
        name,
        description,
        api,
        method,
