...
const { PaymentForm } = require("~/api/v2/models")
...
const getPaymentFormById = async (id) => {
    ...
    if (!paymentForm)
        throw new ApiError(StatusCodes.NOT_FOUND, "Payment form not found")
    return paymentForm
}
